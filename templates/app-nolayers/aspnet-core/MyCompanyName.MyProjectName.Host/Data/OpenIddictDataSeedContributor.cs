...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var webClientRootUrl = configurationSection["MyProjectName_Blazor_Server:RootUrl"].EnsureEndsWith('/');

            /* MyProjectName_Blazor_Server client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["MyProjectName_Blazor_Server:ClientSecret"] ?? "1q2w3e*",
