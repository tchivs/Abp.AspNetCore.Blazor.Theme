...
public static class RadzenThemeConst
{
    public static readonly string[] STYLES = new[] { "_content/Radzen.Blazor/css/material-base.css" };
    public static readonly string[] SCRIPTS = new[] { "_content/Radzen.Blazor/Radzen.Blazor.js" };
}

public class ThemeService:Volo.Abp.DependencyInjection.IScopedDependency
{
    public class Theme
    {
